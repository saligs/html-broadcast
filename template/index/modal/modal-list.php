<div class="modal fade modal-aside vertical top modal-list modal-custom"  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel2" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="padding-30 border-light-grey margin-bottom-20">
					...
					<h3 class="text-center">Undangan Workshop Januari 2016</h3>
					<div class="container">
						<center>
